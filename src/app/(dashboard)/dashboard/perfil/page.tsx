...
import { CheckSquare, AlertTriangle, Calendar, TrendingUp, Shield, Trophy } from 'lucide-react'
import { getEstadisticaUsuario, getRankingUsuario } from '@/lib/actas'
import { PrivacyToggle } from './privacy-toggle'
import { LogrosTab } from '@/components/achievements/logros-tab'
                ...
                <div className="mt-6 p-4 border border-dashed rounded-lg text-center">
                  <p className="text-sm">
                    ...
                    <span className="text-muted-foreground">
                      Has verificado{' '}
                      <strong className="text-foreground">{userStats.actasValidadas}</strong> actas
                      en total.
                    </span>
                  </p>
                </div>
